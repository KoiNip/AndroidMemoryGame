...
public class GameActivity4 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    MemoryCard[] deck = {new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard()};

    //Create an array of the images, with two of each because we need pairs
    Integer[] images = {R.drawable.ic_android, R.drawable.ic_monkey,
            R.drawable.ic_android, R.drawable.ic_monkey};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameActivity4.context = getApplicationContext();
        final String TAG = "GameActivity4";
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int index = 0;
        boolean[] revealed = {false, false, false, false};
