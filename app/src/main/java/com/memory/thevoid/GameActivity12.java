...
public class GameActivity12 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    Integer[] images = {R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender, R.drawable.ic_toast, R.drawable.ic_anchor, R.drawable.ic_sun,
            R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender, R.drawable.ic_toast, R.drawable.ic_anchor, R.drawable.ic_sun};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String TAG = "GameActivity12";
    ...
    public void openHighScore() {
        ...
        intent.putExtra("com.memory.thevoid.gamesize", 12);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int index = 0;
        boolean[] revealed = {false, false, false, false, false, false, false, false, false, false, false,false};
        boolean[] matched = {false, false, false, false, false, false, false, false, false, false, false, false};
