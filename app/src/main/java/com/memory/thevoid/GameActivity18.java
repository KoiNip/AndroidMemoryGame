...
public class GameActivity18 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    ImageButton mButton17;
    ImageButton mButton18;
    //Creates the "deck" of MemoryCard objects
    MemoryCard[] deck = {new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(),
            new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard()};

    //Create an array of the images, with two of each because we need pairs
    Integer[] images = {R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender, R.drawable.ic_toast, R.drawable.ic_anchor, R.drawable.ic_sun, R.drawable.ic_corona, R.drawable.ic_cake, R.drawable.ic_moon,
            R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender, R.drawable.ic_toast, R.drawable.ic_anchor, R.drawable.ic_sun, R.drawable.ic_corona, R.drawable.ic_cake, R.drawable.ic_moon};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameActivity18.context = getApplicationContext();
        final String TAG = "GameActivity18";
        ...
        mButton15 = (ImageButton) findViewById(R.id.card_fifteen);
        mButton16 = (ImageButton) findViewById(R.id.card_sixteen);
        mButton17 = (ImageButton) findViewById(R.id.card_seventeen);
        mButton18 = (ImageButton) findViewById(R.id.card_eighteen);
        ...
        buttons[14] = mButton15;
        buttons[15] = mButton16;
        buttons[16] = mButton17;
        buttons[17] = mButton18;
    ...
    public void openHighScore() {
        ...
        intent.putExtra("com.memory.thevoid.gamesize", 18);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int index = 0;
        boolean[] revealed = {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};
        boolean[] matched = {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};
