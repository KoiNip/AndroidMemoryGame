...
public class GameActivity10 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    MemoryCard[] deck = {new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard(), new MemoryCard()};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameActivity10.context = getApplicationContext();
        final String TAG = "GameActivity10";
    ...
    public void openHighScore() {
        ...
        intent.putExtra("com.memory.thevoid.gamesize", 10);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int index = 0;
        boolean[] revealed = {false, false, false, false, false, false, false, false, false, false};
        boolean[] matched = {false, false, false, false, false, false, false, false, false, false};
