...
public class GameActivity6 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    Integer[] images = {R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender,
            R.drawable.ic_android, R.drawable.ic_monkey, R.drawable.ic_blender};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameActivity6.context = getApplicationContext();
        final String TAG = "GameActivity6";
    ...
    public void openHighScore() {
        ...
        intent.putExtra("com.memory.thevoid.gamesize", 6);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        int index = 0;
        boolean[] revealed = {false, false, false, false, false, false};
        boolean[] matched = {false, false, false, false, false, false};
